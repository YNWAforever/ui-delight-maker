...
export const AGENT_DEFINITIONS: AgentDefinition[] = [
  ...
  },
  {
    ...
    status: "active",
    capabilities: ["ICP scoring", "Budget detection", "Timeline analysis", "Decision maker identification"],
    role: "qualification",
    model: "claude-sonnet-4-6",
    human_approval: false,
  },
  {
    ...
    status: "active",
    capabilities: ["Pricing calculation", "Template selection", "Discount rules", "Proposal generation"],
    role: "quotation",
    model: "claude-sonnet-4-6",
    human_approval: true,
  },
