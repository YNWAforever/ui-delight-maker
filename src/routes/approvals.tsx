        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-5">
          <Card className="lg:col-span-2">
            ...
            <ul className="divide-y divide-border">
              ...
              {pending.length === 0 && (
                <li className="p-6 text-center text-sm text-muted-foreground">Nothing pending.</li>
              )}
            </ul>
          </Card>
                        ...
                        return (
                          <>
                            ...
                            <Button
                              size="sm"
                              onClick={() =>
                                decide(selected.id, "approved", "Approved as-is — quote advanced")
                              }
                            >
                          ...
                          onClick={() =>
                            setConfirm({
                              ...
                              description:
                                "The approval will stay visible as a changes-requested item with your reviewer notes.",
                              label: "Request changes",
                              action: () => decide(selected.id, "escalated", "Changes requested"),
                            })
                          }
                        >
                          <AlertTriangle className="mr-2 h-4 w-4" /> Request changes
